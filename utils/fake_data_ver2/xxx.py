...
if __name__ == '__main__':
    i = 0
    OUT = "/Volumes/Data/WORKSPACE/git/bagiks/CMT-Text-Detection/dataset/crop"
    ...
    with open(os.path.realpath('../../dataset/sample.txt'), 'wb') as w:
        ...
        for line in words:
            ...
            img_path = os.path.join(OUT, word + ".jpg")
